...
1. **Start Services**
   ...
   > **Note**: The MySQL containter starts first and if the app doesn’t start automatically after `docker-compose up --build`, manually start the app service in Docker Desktop.
