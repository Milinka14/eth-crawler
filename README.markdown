...
1. **Start Services**
   ...
   > **Note**: The MySQL containter starts first but the app container may fail to start automatically after `docker-compose up --build`. If so, manually start the app container service in Docker Desktop..
